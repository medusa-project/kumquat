Rails.application.routes.draw do
  ...
  match '/repositories', to: 'repositories#index', via: :get, as: 'repositories'
  match '/repositories/:id', to: 'repositories#show', via: :get, as: 'repository'
  ...
  match '/search-landing', to: 'search_landing#index', via: :get, as: 'search_landing', defaults: { format: 'html' }
  match '/search-landing.js', to: 'search_landing#index', via: :get, defaults: { format: 'js' }
  match '/special-collections-search', to: 'special_collections_search#index', via: :get,
        as: 'special_collections_search'
