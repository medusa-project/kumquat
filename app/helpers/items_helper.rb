module ItemsHelper
  ...
  def download_button(item, options = {})
    return nil unless item.bytestreams.select{ |b| b.type == Bytestream::Type::ACCESS_MASTER}.any? or
        item.bytestreams.select{ |b| b.type == Bytestream::Type::PRESERVATION_MASTER}.any?
=begin
