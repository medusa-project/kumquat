...
class RightsStatement
  ...
  ALL_STATEMENTS = [
      ...
      },
      {
          ...
          info_uri: 'https://rightsstatements.org/page/InC-EDU/1.0/'
      },
      {
          ...
          info_uri: 'https://rightsstatements.org/page/InC-NC/1.0/'
      },
      {
          ...
          info_uri: 'https://rightsstatements.org/page/InC-RUU/1.0/'
      },
      {
          ...
          info_uri: 'https://rightsstatements.org/page/NoC-CR/1.0/'
      },
      {
          uri: 'http://rightsstatements.org/vocab/NoC-NC/1.0/',
          name: 'No Copyright - Non-Commercial Use Only',
          image: 'rightsstatements.org/NoC-CR.dark-white-interior.svg',
          info_uri: 'https://rightsstatements.org/page/NoC-NC/1.0/'
      },
      {
          ...
          info_uri: 'https://rightsstatements.org/page/NoC-OKLR/1.0/'
      },
      {
          ...
          info_uri: 'https://rightsstatements.org/page/NoC-US/1.0/'
      },
      {
          ...
          info_uri: 'https://rightsstatements.org/page/CNE/1.0/'
      },
      {
