...
class PackageProfileTest < ActiveSupport::TestCase
  ...
  test 'bytestreams_from_tsv with the free-form profile and Medusa TSV should
    ...
    assert_equal 1, PackageProfile::FREE_FORM_PROFILE.
  ...
  test 'bytestreams_from_tsv with the map profile and Medusa TSV should return
    ...
    assert_equal 0, PackageProfile::MAP_PROFILE.
  ...
  test 'bytestreams_from_tsv with the map profile and Medusa TSV should return
    ...
    assert_equal 2, PackageProfile::MAP_PROFILE.
  ...
  test 'children_from_tsv with the free-form profile and Medusa TSV should
    ...
    assert_equal 3, PackageProfile::FREE_FORM_PROFILE.
        children_from_tsv(item, @medusa_free_form_tsv).length
  end
  ...
  test 'children_from_tsv with the map profile and Medusa TSV should return an
    ...
    assert_equal 6, PackageProfile::MAP_PROFILE.
  ...
  test 'items_from_tsv with the free-form profile and Medusa TSV should return items' do
    assert_equal 50, PackageProfile::FREE_FORM_PROFILE.
  ...
  test 'items_from_tsv with the free-form profile and DLS TSV should return items' do
    assert_equal 2, PackageProfile::FREE_FORM_PROFILE.
  ...
  test 'items_from_tsv with the map profile and Medusa TSV should return items' do
    assert_equal 555, PackageProfile::MAP_PROFILE.
  ...
  test 'items_from_tsv with the map profile and DLS TSV should return items' do
    assert_equal 4, PackageProfile::MAP_PROFILE.
  ...
  test 'parent_id_from_tsv should raise an error when no ID is provided' do
    assert_raises ArgumentError do
      PackageProfile::FREE_FORM_PROFILE.parent_id_from_tsv(nil, @dls_free_form_tsv)
    end
  end
  ...
  test 'parent_id_from_tsv with the free-form profile and DLS TSV should
    ...
    item = 'a53add10-5ca8-0132-3334-0050569601ca-7'
    assert_nil PackageProfile::FREE_FORM_PROFILE.
  ...
  test 'parent_id_from_tsv with the free-form profile and DLS TSV should return
    ...
    assert_equal expected_parent, PackageProfile::FREE_FORM_PROFILE.
  ...
  test 'parent_id_from_tsv with the map profile and DLS TSV should return nil
        with top-level items' do
    item = 'be8d3500-c451-0133-1d17-0050569601ca-9'
    assert_nil PackageProfile::MAP_PROFILE.parent_id_from_tsv(item, @dls_map_tsv)
  end
  ...
  test 'parent_id_from_tsv with the map profile and DLS TSV should return the
    ...
    assert_equal expected_parent, PackageProfile::MAP_PROFILE.
  ...
  test 'parent_id_from_tsv with the map profile and Medusa TSV should return nil
        with top-level items' do
    item = '2ac46220-e946-0133-1d3d-0050569601ca-5'
    assert_nil PackageProfile::MAP_PROFILE.parent_id_from_tsv(item, @medusa_map_tsv2)
  end
  ...
  test 'parent_id_from_tsv with the map profile and Medusa TSV should return nil
    ...
    assert_nil PackageProfile::MAP_PROFILE.
  ...
  test 'top_dir_id with Medusa TSV should return the top dir ID' do
    assert_equal '431d6090-5ca7-0132-3334-0050569601ca-a',
                 PackageProfile::MAP_PROFILE.top_dir_id(@medusa_free_form_tsv)
  end
  ...
  test 'top_dir_id with DLS TSV should raise an error' do
    assert_raises ArgumentError do
      PackageProfile::MAP_PROFILE.top_dir_id(@dls_free_form_tsv)
    end
  end
